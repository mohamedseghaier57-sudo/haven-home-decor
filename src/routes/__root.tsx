...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maison Cadre — Wholesale Photo Frames & Home Décor" },
      {
        name: "description",
        content:
          "Trade-only marketplace for photo frames, mirrors, posters and wall décor. Wholesale pricing, low minimums, fast EU delivery.",
      },
      { name: "author", content: "Maison Cadre" },
